...
\centering![](point_sur_cercle.png){width=50%}\par
...
![Tore plat par MS (Blender)](flat_torus_n_6_k_1p5_r_2_h_3.jpg){width=65%}

## Pliages en papier hyperbolique (ou Kombucha)

![Papier hyperbolique par Abrams, Paul et MS, photos par Harris.](hyperbolic-paper-harris.jpg){width=48%}
...
\begin{figure}[!h]
\caption{Objets imprimés en 3D (gauche), surface en plâtre (droite).}
\end{figure}
