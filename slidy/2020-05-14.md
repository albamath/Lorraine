...
\centering![](cercle-arc.png){height=300}{width=60%}\par

Conjugué à :

\centering![](segment-segment.png){width=60%}\par
...
[![Snake around a "corner"](snake-around-corners.png){width=60%}](http://albamath.com/snake)
...
[![Snake around the corner](snake-l-corner-4.png){width=60%}](http://albamath.com/snake-L)
...
[![Snake around the corner](snake-x-corner-4.png){width=60%}](http://albamath.com/snakeX)
...
\centering![Dynamique sur le tore](flot-tore.png){width=60%}\par
...
\centering![](triangle-1.png){width=40%}\par
...
\centering![Parallélogramme deplié partiellement](parallelogramme-deplie-n-fois.png){width=90%}\par

------------------------------------------------------

\centering![](rebond-cas-special.png){width=60%}\par
...
\centering![Escalier à hauteur variable](escalier-hauteur-variable.png){width=60%}\par

## Le modèle wind-tree des Ehrenfest: 

[![Dynamique du wind tree, appli. de Roger Antonsen](wind-tree.png){width=60%}](https://rantonse.no/demos/MirrorRoom/)
...
\centering![Orbites sur une surface en escalier à recouvrement variable](orbites-escalier.png){width=100%}\par
...
[![Tores plats par Lelièvre et M, photographiés par Edmund Harris](flat-tori-harris.jpg){width=80%}](https://p3d.in/u/albamath/zJFfh)

## Pliages en papier hyperbolique (ou Kombucha)

\centering![Papier hyperbolique par Abrams, Paul et M, photographiés par Edmund Harris.](hyperbolic-paper-harris.jpg){width=80%}\par

## Impression 3D de surfaces algébriques

\centering![Quelques surfaces algébriques](surfaces-alg.jpg){width=100%}\par

-----------------------------------------------------

\centering![Miaou par Herwig Hauser](miau.jpg){width=100%}\par

## Impression 3D d'autres objets mathématiques

\centering![objets-3D-sur-echarpe-rouge.png](objets-3D-sur-echarpe-rouge.png){width=100%}\par

## Analyse d'anciens objets en plâtre

\centering![Surface de Kummer, collections de l'IHP](kummer-platre-a.jpg){width=100%}\par
