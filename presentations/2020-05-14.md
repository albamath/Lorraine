...
![cercle-arc.png](cercle-arc.png)

Conjugué à :

![segment-segment.png](segment-segment.png)
...
[![Snake around a "corner"](snake-around-corner.png)](http://albamath.com/snake)
...
![Parallélogramme](parallelogramme-h-eps-l.tiff)
