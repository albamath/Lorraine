...
\includegraphics{cercle-arc.png}
...
Paramétre: \(α ∈ [0,1[\) Espace des phases: \(𝕋 = ℝ/ℤ = [0,1]/\{0~1\}\)
...
\href{http://albamath.com/snake}{\includegraphics{snake-on-a-torus.png}}
...
\href{http://albamath.com/snake}{\includegraphics{snake-around-corners.png}}

\(χ = V-E+F = 1 - 2 + 1 = 0\) \(χ=2-2g\) \(g=1\).
...
\href{http://albamath.com/snake-L}{\includegraphics{snake-l-corner.png}}
...
\href{http://albamath.com/snake-L}{\includegraphics{snake-l-corner-4.png}}
...
\href{http://albamath.com/snakeX}{\includegraphics{snake-x-corner-4.png}}

\(χ = V-E+F = 1 - 6 + 3 = -2\) \(χ=2-2g\) \(g=2\).
...
\begin{figure}
\centering
\includegraphics{parallelogramme-h-eps-l.tiff}
\caption{Parallélogramme}
\end{figure}
...
\href{https://rantonse.no/demos/MirrorRoom/}{\includegraphics{wind-tree.png}}
